...
public class Session {
    ...
    public int delete(Class<User> clz, Criterion criterion) {
        String tableName = StringUtils.uncapitalize(clz.getSimpleName());
    ...
    public Criteria createCriteria(Class<User> clz, String alias) {
        return new Criteria(clz, alias, this);
    }

    public Criteria createCriteria(Class<User> clz) {
