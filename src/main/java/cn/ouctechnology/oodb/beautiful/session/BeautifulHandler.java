...
import cn.ouctechnology.oodb.beautiful.annotation.*;
 ...
 * @description: TODO
 **/
public class BeautifulHandler implements InvocationHandler {
    private Logger logger = LoggerFactory.getLogger(BeautifulHandler.class);
    private Session session;

    private Map<String, Object> columnValueMap;


    public BeautifulHandler(Session session) {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) {
        ...
        if (oql == null) throw new DbException("unsupported operator");
    ...
    private String fillParams(String oql, List<String> paramList) {
        ...
        for (int i = 0; i < paramList.size(); i++) {
            ...
            if (value == null) {
                ...
                if (value == null)
                    throw new DbException("can not found the property");
            }
            values[i] = value;
        }
